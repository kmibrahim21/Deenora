...
import { Home, User, BookOpen, Wallet, ShieldCheck, BarChart3, CreditCard, RefreshCw, Smartphone, Bell, X, Info, AlertTriangle, CheckCircle2, Clock, Calculator, ClipboardList, GraduationCap, Banknote, MessageSquare, Users, Mic, LogOut, Menu } from 'lucide-react';
...
const DesktopLayout: React.FC<LayoutProps> = ({ children, currentView, setView, lang, madrasah, profile }) => {
  ...
  const getViewTitle = (view: string) => {
    const titles: Record<string, string> = {
      ...
      'teachers': t('teachers', lang, madrasah?.institution_type) || 'Teachers',
